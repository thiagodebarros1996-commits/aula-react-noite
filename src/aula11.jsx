...
class Aula11 extends Component {
  ...
  async salvaNoBanco() {
    ...
    const IP_DA_SUA_MAQUINA = 'http://192.168.0.210:3000';
    ...
    return (
      <View style={styles.container}>
        <TextInput
          ...
          onChangeText={(texto) => this.setState({ campo1: texto })}
        />
        ...
        <TextInput
          ...
          onChangeText={(texto) => this.setState({ campo2: texto })}
        />

        <Button title="Salvar e Exibir" onPress={this.salvaNoBanco} />
